...
<body>
    ...
    <canvas id="canvas" style="display: none;" width="100px" height="100px"></canvas>
            	...
            	<div class="checkout">
	                <div class="container">
            			<form action="checkout-submit" method="POST">
            				@csrf
            				<input type="text" value="" name="transactionId" class="form-control" id="transaction-id">
            				<hr>
            				<script>
								...
								document.getElementById('transaction-id').value = "#" + generateRandomNumbers();
							</script>
		                	<div class="row">
		                		<div class="col-lg-9">
		                		...
		                		<aside class="col-lg-3">
		                			<div class="summary">
		                					...
		                					<tbody>
		                						...
		                						@if(isset($cart))
			                						...
			                						@foreach($cart as $data)
				                						...
				                						<?php $products .= "&" . strval($data->product_id); ?>
		                				...
		                				<button type="submit" id="security-checkout" class="btn btn-outline-primary-2 btn-order btn-block">
